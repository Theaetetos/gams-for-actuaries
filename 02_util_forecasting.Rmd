...
ggplot(dat, aes(yrfrac, y)) +
  ...
  geom_smooth(
    method = 'gam',
    formula = y ~ s(x, bs = 'cs'),
    color = colors$Visualization$Rainwater
  ) +
  labs(
...
This drug, however, may be an exception based on this plot.
...
# holidays - there are more efficient ways to do this, but they required more advanced coding
...
ggplot(pdat) +
  ...
  labs(title = 'Modeled Trend Component') +
  mytheme +
  theme(
